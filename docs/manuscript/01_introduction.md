...
The present catalog contains {{CATALOG_ENTRIES}} entries, of which
{{IMPLEMENTED_COUNT}} are implemented, {{PLANNED_COUNT}} are planned, and
{{INPUT_REQUIRED_COUNT}} require external fixtures. This status vocabulary
